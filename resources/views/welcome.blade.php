...
<body class="relative py-2 overflow-x-hidden font-plusjakarta">
    ...
    <header
        ...
        <div class="flex space-x-2">
            <a href="{{ route('login') }}" class="bg-blue text-white px-6 py-1 rounded-lg">login</a>
            <a href="{{ route('login', ['mode' => 'register']) }}" class="bg-blue text-white px-6 py-1 rounded-lg">register</a>
        </div>
    </header>
